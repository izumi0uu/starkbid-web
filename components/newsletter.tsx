...
const Newsletter: React.FC = () => {
    ...
    return (
        <div className="mx-auto container bg-purple bg-cover rounded-[3rem] text-white relative overflow-hidden h-auto md:h-[35vh] flex items-center px-6 sm:px-10 lg:px-[10rem] py-10 mb-4">
            {/* top star */}
            <Image
                src={stars}
                height={50}
