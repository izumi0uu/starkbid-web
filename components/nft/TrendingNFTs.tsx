    ...
    <div className="bg-black text-white p-6 max-w-[1419px] mx-auto">
      <div className="flex justify-between items-center mb-6">
        <div className="flex gap-4">
          ...
          <button
            className={`px-4 py-2 text-lg font-semibold ${
              activeTab === 'top' ? 'text-white border-b-2 border-white' : 'text-gray-500'
            }`}
        ...
        <div className="flex gap-4 items-center">
          <input
            ...
            className="bg-[#1C1D1F] text-white placeholder-gray-500 text-sm px-4 py-2 rounded-md outline-none border border-[#292929] w-48"
          />
          <select
            value={filter}
            onChange={(e) => setFilter(e.target.value)}
            className="bg-[#1C1D1F] text-white text-sm px-4 py-2 rounded-md outline-none border border-[#292929]"
          >
      ...
      <h2 className="text-2xl font-bold mb-4">
        ...
        <span className="text-gray-400 text-base">{displayedNFTs.length} Items</span>
      </h2>
