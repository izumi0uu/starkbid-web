...
export const NFTLatestList = () => {
  ...
  return (
    <div className=" lg:pl-10 xl:pl-[80px]">
      <div className="flex items-center justify-between sm:mb-2 mb-0  sm:mt-0">
        <h4 className="text-white font-bold text-[18px] sm:text-[22px]">
          Latest NFT Drops
        </h4>
        <button
          aria-label="View All"
        ...
        return (
          ...
          >
            <div
              ...
              ${
                nftIndex === idx
                  ? "scale-105 border-2 shadow-lg border-[#fff]"
                  : "scale-95"
              }
            `}
            >
              ...
              <div className="p-4">
                ...
                <p className="text-white text-sm font-medium text-[12px]">
                  {nft.category}
                </p>
              </div>
            </div>
